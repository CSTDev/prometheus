...
class Panel extends Component<PanelProps, PanelState> {
  ...
  executeQuery = (expr: string): void => {
    ...
    const resolution =
      ...
      Math.max(Math.floor(this.props.options.range / 250), 1);
          ...
          <Col>
            <Nav tabs>
              <NavItem>
                <NavLink
                  className={
                    this.props.options.type === 'table' ? 'active' : ''
                  }
                  onClick={() => {
              ...
              <NavItem>
                <NavLink
                  className={
                    this.props.options.type === 'graph' ? 'active' : ''
                  }
                  onClick={() => {
                ...
                {this.props.options.type === 'graph' && (
                  <>
                    ...
                    <Graph
                      ...
                      stacked={this.props.options.stacked}
                      queryParams={this.state.lastQueryParams}
                    />
                  </>
                )}
              </TabPane>
